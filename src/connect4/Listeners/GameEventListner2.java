...
public class GameEventListner2 implements GLEventListener , KeyListener {
    ...
    int x = 0 , y = 0;
    String[] textureNames = {"Bord.png" , "POG-red.png" , "POG-yellow.png" , "Basic Text.png" ,  "Flat_Game_Background_3 1.png"}; //The Sprits
