...
public class GameEventListener2 implements GLEventListener {
    int maxWidth = 100; //Initial Positions
    int maxHeight = 100;
    String[] textureNames = {"Bord-1.png" , "POG-red.png" , "POG-yellow.png" , "Basic Text.png" ,  "BG-1.png"}; //The Sprits
